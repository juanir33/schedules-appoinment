...
import { Sparkles, Calendar, Star, ArrowRight, Phone, MapPin, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50">
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-display text-2xl font-bold mb-4">Salón de Uñas Elegancia</h3>
              <p className="text-gray-400 mb-4">Tu destino para el cuidado profesional de uñas</p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Salón de Uñas Elegancia. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
